...
import p1_LocionVS from '../assets/images/p1_LocionVS.jpg'
import p2_LocionVS from '../assets/images/p2_LocionVS.jpg'
import p3_LocionVS from '../assets/images/p3_LocionVS.jpg'
import p4_LocionVS from '../assets/images/p4_LocionVS.jpg'
import p5_LocionVS from '../assets/images/p5_LocionVS.jpg'
import p6_LocionVS from '../assets/images/p6_LocionVS.jpg'
import p7_LocionVS from '../assets/images/p7_LocionVS.jpg'
import p8_LocionVS from '../assets/images/p8_LocionVS.jpg'
        ...
        <div className='grupo_cosmeticos'>
            <div className='pruductos-especiales-seciones'>
              <div className='slider-carrusel_secciones'>
                ...
                <div className='product-details-secciones'>
                  ...
                  <h3><b>Locion VS Temptation</b></h3>
                  </div>
                </div>
              </div>
              <div className='slider-carrusel_secciones'>
              ...
              <div className='slider-carrusel_secciones'>
                ...
                <div className='product-details-secciones'>
                  <div className='product-name'>
                    <h3><b>Locion VS Lone Spell</b></h3>
                  </div>
                </div>
              </div> 
              <div className='slider-carrusel_secciones'>
            ...
            <div className='pruductos-especiales-seciones'>
              ...
              <div className='slider-carrusel_secciones'>
                ...
                <div className='product-details-secciones'>
                  <div className='product-name'>
                    <h3><b>Locion VS Purple Haze</b></h3>
                  </div>
                </div>
              </div>
              <div className='slider-carrusel_secciones'>
