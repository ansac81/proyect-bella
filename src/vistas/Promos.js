...
import promociones1 from '../assets/images/promociones1.jpg';
import promociones2 from '../assets/images/promociones2.jpg';
import promociones3 from '../assets/images/promociones3.jpg';
import promociones4 from '../assets/images/promociones4.jpg';
...
function Home() {
  ...
  {/*Aqui comienza el Slider*/}
        <div className="contenido-promos">  
          <div className='promo'>
            <img src={promociones1}/>
          </div>
          <div className='promo'>
            <img src={promociones2}/>
          </div>
          <div className='promo'>
            <img src={promociones3}/>
          </div>
          <div className='promo'>
            <img src={promociones4}/>
          </div>
        </div>
